...
StudioView.STUDIO_API = 'https://arkideapi.arc360hub.com/api/v1';

// The URL to download thumbnails from.
// $id is replaced with the project's ID.
StudioView.THUMBNAIL_SRC = 'https://arkideapi.arc360hub.com/api/v1/projects/getproject?projectID=$id&requestType=thumbnail';

// The URL for project pages.
// $id is replaced with the project ID.
StudioView.PROJECT_PAGE = 'https://studio.arkide.site/#$id';
...
const API_URL = 'https://arkideapi.arc360hub.com/api/v1/projects/getproject?projectID=$id&requestType=metadata';
const API_REMIX_URL = 'https://arkideapi.arc360hub.com/api/v1/projects/getremixes?projectId=$id';
  ...
  class ProjectMetaFetcherComponent extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
    ...
    componentDidUpdate() {
      ...
      fetchProjectMeta(projectId).then(data => {
        ...
        const authorThumbnail = "https://arkideapi.arc360hub.com/api/v1/users/getpfp?username=".concat(data.author.username);
...
// eslint-disable-next-line max-len
, {
  defaultMessage: "ArkIDE, Penguinmod and TurboWarp are not affiliated with Scratch, the Scratch Team, or the Scratch Foundation.",
  ...
  href: "https://arkide.site/desktop"
  ...
  href: "https://github.com/The-ArkIDE-Project/ArkIDE-Home/issues"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(react_intl__WEBPACK_IMPORTED_MODULE_5__["FormattedMessage"], {
...
class Interface extends react__WEBPACK_IMPORTED_MODULE_2___default.a.Component {
  ...
  handleUpdateProjectTitle(title, isDefault) {
    if (isDefault || !title) {
      document.title = "ArkIDE - ".concat(this.props.intl.formatMessage(messages.defaultTitle));
    } else {
      document.title = "".concat(title, " - ArkIDE");
    }
  }
  copyProjectLink(id) {
    if ('clipboard' in navigator && 'writeText' in navigator.clipboard) {
      navigator.clipboard.writeText("https://arkideapi.arc360hub.com/".concat(id));
    }
  }
  render() {
    const _this$props = this.props,
